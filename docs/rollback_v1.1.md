...
5. If only publication fails, leave the last successful `output/latest.json` in place and repair on a branch. Do not publish a failed or partially validated artifact.
